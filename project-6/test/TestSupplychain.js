...
contract('SupplyChain', function(accounts) {
    ...
    it("Testing smart contract function buyItem() that allows a distributor to buy coffee", async() => {
      ...
      var balanceOfUser1BeforeTransaction = await web3.eth.getBalance(originFarmerID);
      ...
      var balanceOfUser1AfterTransaction = await web3.eth.getBalance(originFarmerID);
      var value1 = Number(balanceOfUser1BeforeTransaction) + Number(productPrice);
      var value2 = Number(balanceOfUser1AfterTransaction);
    ...
    it("Testing smart contract function fetchItemBufferOne() that allows anyone to fetch item details from blockchain", async() => {
      ...
      assert.equal(resultBufferOne[2], consumerID, 'Error: Invalid owner')
      assert.equal(resultBufferOne[3], originFarmerID, 'Error: Invalid original farmer')
      assert.equal(resultBufferOne[4], originFarmName, 'Error: Invalid original farmer name')
      assert.equal(resultBufferOne[5], originFarmInformation, 'Error: Invalid original farm information')
      assert.equal(resultBufferOne[6], originFarmLatitude, 'Error: Invalid original farm latitude')
      assert.equal(resultBufferOne[7], originFarmLongitude, 'Error: Invalid original farm longtitude')
